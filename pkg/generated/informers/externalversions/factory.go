...
type SharedInformerFactory interface {
	...
	Credentials() credentialsmjpitzcom.Interface
}

func (f *sharedInformerFactory) Credentials() credentialsmjpitzcom.Interface {
	return credentialsmjpitzcom.New(f, f.namespace, f.tweakListOptions)
}
